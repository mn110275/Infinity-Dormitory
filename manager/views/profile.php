    ...
    try {
        ...
        if (isset($_FILES['mng_img']) && $_FILES['mng_img']['error'] === UPLOAD_ERR_OK) {
            ...
            if (in_array($fileExt, $allowedExts)) {
                $fileName = 'manager_' . $userId . '_' . time() . '.' . $fileExt;
      ...
      <div class="profile-sidebar">
        ...
        <div class="info-card">
          <div style="text-align: center;">
            <h3><?= htmlspecialchars($manager['MNG_NAME']) ?></h3>
            <p class="role-badge">Quản lý tòa <?= htmlspecialchars($manager['MNG_BLOCK']) ?></p>
          </div>
          <div class="info-item">
            <strong>Mã QL:</strong>
          ...
          <div class="form-section">
            ...
            <div class="form-grid">
              ...
              <div class="form-group">
                ...
                <input type="date" class="form-control" value="<?= date('Y-m-d', strtotime($manager['MNG_DOB'])) ?>" disabled>
              </div>
            ...
            <div class="form-grid">
              <div class="form-group">
                ...
                <input type="tel" name="mng_phone" id="mng_phone" class="form-control" 
                       value="<?= htmlspecialchars($manager['MNG_PHONE']) ?>" 
                       required pattern="[0-9]{10,11}" placeholder="0901234567">
              </div>

              <div class="form-group full-width">
                <label for="mng_adr">Địa chỉ *</label>
                <textarea name="mng_adr" id="mng_adr" class="form-control" rows="2" 
                          required placeholder="Nhập địa chỉ đầy đủ"><?= htmlspecialchars($manager['MNG_ADR']) ?></textarea>
              </div>
            </div>
          </div>
