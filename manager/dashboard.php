  ...
  <main class="admin-container">
    <aside class="sidebar">
      ...
      <nav id="sidebarList" class="sidebar-list">
        <!-- Các mục sidebar sẽ được render bằng JS -->
      </nav>
    ...
    <section id="adminContent" class="content-area">
      <div id="contentInner" class="content-inner">
        <!-- Nội dung động (bảng, ma trận,...) sẽ render vào đây -->
      </div>
    </section>

    <!-- Viewer phải (gạt sang) -->
    <aside id="viewer" class="viewer" aria-hidden="true">
      ...
      <div class="viewer-body">
        ...
        <div id="viewerThumbs" class="viewer-thumbs">
          <!-- thumbnails sẽ được render ở đây -->
        </div>
        <div id="viewerLinks" class="viewer-links">
          <!-- ví dụ: link, mô tả ngắn -->
        </div>
      </div>
    </aside>
  </main>
