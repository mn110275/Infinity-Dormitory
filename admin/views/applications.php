...
<div class="view-toggles" style="display:flex; margin: 20px 0; gap: 15px;">
  <button class="btn btn-pro toggle-view active" data-status="chua-xu-ly" onclick="ApplicationAdmin.switchView('chua-xu-ly', this)">
  Đơn chờ xử lý (<?= count(array_filter($applications, fn($a) => $a['REG_STATUS'] === 'Chưa xử lý')) ?>)
  </button>
  <button class="btn btn-secondary toggle-view" data-status="da-chap-nhan" onclick="ApplicationAdmin.switchView('da-chap-nhan', this)">
  Đã chấp nhận
  </button>
  <button class="btn btn-secondary toggle-view" data-status="da-tu-choi" onclick="ApplicationAdmin.switchView('da-tu-choi', this)">
  Đã từ chối
  </button>
</div>
    ...
    <thead>
      <tr>
        ...
        <th style="width:120px">
          <div class="th-content" data-col="2"><span>MSSV</span><span class="sort-icon">⇅</span></div>
          <input class="col-search" data-col="2" placeholder="MSSV...">
        </th>
        <th style="width:140px">
          <div class="th-content" data-col="5"><span>Trạng thái</span><span class="sort-icon">⇅</span></div>
          <input class="col-search" data-col="5" placeholder="Lọc...">
        </th>
        <th style="width:200px">
          <div class="th-content" data-col="6"><span>Ngày gửi</span><span class="sort-icon">⇅</span></div>
