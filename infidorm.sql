...
FOR EACH ROW
BEGIN
    -- TH1: Thay đổi trạng thái từ Active sang loại khác 
    IF OLD.STATUS = 'Active' AND NEW.STATUS <> 'Active' THEN
        UPDATE ROOM SET OCCUPIED = OCCUPIED - 1 
        WHERE ROOM_ID = OLD.ROOM_ID AND BLOCK_ID = OLD.BLOCK_ID;

    -- TH2: Kích hoạt lại hợp đồng (Từ trạng thái khác sang Active)
...
INSERT INTO SEMESTER (SEM_ID, STARTDATE, ENDDATE, IS_CURRENT) VALUES
('20251', '2025-09-01', '2026-02-15', TRUE);
